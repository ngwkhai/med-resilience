              ...
              <Card className="bg-slate-900 border-slate-700 text-white">
                <CardContent className="pt-4 space-y-3 text-sm font-mono">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-white">4m</span>
                  </div>
                  <div className="flex justify-between items-center border-t border-slate-700 pt-2">
                    <span className="text-green-400">Tốc Độ Gió</span>
                    <span className="text-white">5 km/h</span>
                  </div>
                  <div className="flex justify-between items-center border-t border-slate-700 pt-2">
...
export default function DroneControlPage() {
  ...
  const handleLogout = async () => {
    await signOut();
    router.push('/auth/admin-login?role=operator');
  };

  return (
    <ProtectedRoute requiredRoles="operator" redirectTo="/auth/admin-login?role=operator">
